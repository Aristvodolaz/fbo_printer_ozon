...
echo [ИНФО] Приложение будет доступно по адресу: http://localhost:22
echo [ВНИМАНИЕ] Порт 22 обычно используется для SSH. Если возникнет конфликт, используйте другой порт.
